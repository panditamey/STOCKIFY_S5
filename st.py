# pip install streamlit prophet nsepy plotly
...
stock = st.text_input('Stock Symbol', "SBIN")
st.write('Kindly Enter Stock Symbol for Prediction')
...
def load_data(ticker):
    data = get_history(symbol=ticker, start=date(2015, 1, 1), end=TODAY)
